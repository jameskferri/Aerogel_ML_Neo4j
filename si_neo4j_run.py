...
def main():
    ...
    insert_paper_error(new_df, driver, database, prop_key="control_paper_error")
    insert_errors(new_df, driver, database, prop_key="control_outliers_error")
    insert_predicted_values(new_df, driver, database, prop_key="control_predicted_surface_area")
    insert_predicted_std_values(new_df, driver, database, prop_key="control_predicted_surface_area_std")
